...
pub struct QueryRequest {
    ...
    pub time: ::std::collections::HashMap<::prost::alloc::string::String, TimeQuery>,
...
pub mod user_stats_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/user_stats.UserStats/CreateUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user_stats.UserStats", "CreateUser"));
            self.inner.server_streaming(req, path, codec).await
        }
    }
}
...
pub mod user_stats_server {
    ...
    pub trait UserStats: std::marker::Send + std::marker::Sync + 'static {
        ...
        type CreateUserStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::User, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        ...
        ) -> std::result::Result<tonic::Response<Self::CreateUserStream>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/user_stats.UserStats/CreateUser" => {
                    #[allow(non_camel_case_types)]
                    struct CreateUserSvc<T: UserStats>(pub Arc<T>);
                    impl<
                        T: UserStats,
                    ...
                    for CreateUserSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserStats>::create_user(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
